 ...
 * <p>
 * Handles user registration with BCrypt password encoding, login via
 * Spring Security's AuthenticationManager, and token refresh with rotation.
 * JWT tokens are generated by JwtUtil. SecurityContextHolder is accessed
 * only in getCurrentUser() to centralize security context dependency.
 */
@Service
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse refresh(RefreshTokenRequest request) {
        ...
        // Token rotation: issue new access + refresh tokens, old refresh token is discarded
        return buildAuthResponse(user);
    }
    ...
    /**
     * Builds an AuthResponse with both access and refresh tokens.
     * <p>
     * The {@code token} field is set to the access token value for
